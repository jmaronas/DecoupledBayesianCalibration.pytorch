...
do
	...
	python ../main_ELBO.py --model_net $model --n_layers $layers --layer_dim $neurons --dkl_scale_factor $dklsf --dkl_after_epoch -1 --batch 100 --lr $lr --epochs $epochs --MC_samples $MC --n_gpu $n_gpu --anneal Linear --data_dir ./data/ --dataset $dataset --folder_name $MC"MC_"$total_epochs"eps_DKLSF"$dklsf
